    ...
    render() {
        ...
        const renderList = () => {
            return props.list.size === 0 ? (
                <NoneData loading={props.loading} buttonName='去新建项目' onClick={this.handleCreateClick}>没有找到项目</NoneData>
            ) : (
        ...
        const renderToolbar = () => {
            return props.list.size > 0 ? (
                <div className={className('tagToolbar')}>
                    <Button size="large" onClick={this.handleCreateClick}>添加项目<Icon type="add" /></Button>
                </div>
            ) : null;
        };
